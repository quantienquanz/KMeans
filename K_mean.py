...
text_random = font.render('Rundom', True, WHITE)
...
while running: 
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if 50 < mouse_x < 750 and 50 < mouse_y < 550: # Bấm trong khoảng panel thì nó chạy
                labels = []
                point = [mouse_x - 50,mouse_y - 50] # lưu lại x,y
                points.append(point) #points là 1 list, append là thêm vào 1 list,thêm vào cái point
            ...
            if 850 < mouse_x < 1000 and 150 < mouse_y < 200:
                ...
                if clusters == []:
                    continue
                #gán những điểm vào những màu gần nhất
                for p in points:
